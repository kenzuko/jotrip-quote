...
for(const viewport of [{name:'desktop',width:1440,height:900},{name:'iphone',width:390,height:844},{name:'compact',width:320,height:720}]){
 ...
 const homeCheck=await inspect(page,`${viewport.name}-home`);if(viewport.name==='iphone'&&!homeCheck.openingStoryInFirstView)throw Error('Mobile opening story image should be visible in the first viewport');
